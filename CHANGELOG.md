...
## [0.1.50](https://github.com/xiayuanyin/aion_core/compare/v0.1.49...v0.1.50) (2026-09-10)


### Features

* **acp,conversation:** elevate ACP protocol + assistant lineage logs to info ([#318](https://github.com/xiayuanyin/aion_core/issues/318)) ([fbcb299](https://github.com/xiayuanyin/aion_core/commit/fbcb29962da5ca4f52516663d592b57815875873))
* **acp:** use observed config options for preferences ([#468](https://github.com/xiayuanyin/aion_core/issues/468)) ([fd2d5c2](https://github.com/xiayuanyin/aion_core/commit/fd2d5c2db10e80dc478ee88c2d1f787e91015eb1))
* **acp:** warmup opens session eagerly + model-identity reminder via BehaviorPolicy ([#207](https://github.com/xiayuanyin/aion_core/issues/207)) ([09aa98b](https://github.com/xiayuanyin/aion_core/commit/09aa98b720bdefb8cb3b705ea835bc1d0a910cd8))
* add deepseek-flash and deepseek-pro image input support ([e103865](https://github.com/xiayuanyin/aion_core/commit/e103865977630b0897dd7179063b786a2a52cc9e))
* add is_full_url flag for provider URL resolution ([#307](https://github.com/xiayuanyin/aion_core/issues/307)) ([3aa15da](https://github.com/xiayuanyin/aion_core/commit/3aa15da0c70a15da097e5bd839b83c4c0c720bf1))
* **agent:** classify structured agent send errors ([#356](https://github.com/xiayuanyin/aion_core/issues/356)) ([f52e8cd](https://github.com/xiayuanyin/aion_core/commit/f52e8cd93edb3e5edbee450ca41bef49e4cc9c48))
* **agent:** detect availability via session/new probe and assistant-first identity ([#500](https://github.com/xiayuanyin/aion_core/issues/500)) ([6c9a721](https://github.com/xiayuanyin/aion_core/commit/6c9a721fc4cf2b712f5c7b974f51b2935a0293b7))
* **agents:** add Pi coding agent as builtin ACP agent ([#618](https://github.com/xiayuanyin/aion_core/issues/618)) ([0b9b3a8](https://github.com/xiayuanyin/aion_core/commit/0b9b3a882712f555e60fd33c027b604471df25c7))
* **agents:** sync ACP Registry integrations ([#637](https://github.com/xiayuanyin/aion_core/issues/637)) ([7d35e38](https://github.com/xiayuanyin/aion_core/commit/7d35e386969bb2dca58ca332adf00f9ae5bed6ce))
* **agent:** use aionrs runtime env API ([#586](https://github.com/xiayuanyin/aion_core/issues/586)) ([2f6f43f](https://github.com/xiayuanyin/aion_core/commit/2f6f43f305221701ca2baa58123180caf2342055))
* **ai-agent:** adapt to aionrs v0.2.2 config changes ([4f71bf2](https://github.com/xiayuanyin/aion_core/commit/4f71bf2c97de1bafc676906e26a5cf512ff94af9))
* **ai-agent:** add cc-switch provider env injection for Claude ACP ([#291](https://github.com/xiayuanyin/aion_core/issues/291)) ([a7b93e7](https://github.com/xiayuanyin/aion_core/commit/a7b93e7dde78a7b254e26e2d2e25d7b9b885ad5b))
* **ai-agent:** custom agent CRUD + two-step probe ([#211](https://github.com/xiayuanyin/aion_core/issues/211)) ([ebfd297](https://github.com/xiayuanyin/aion_core/commit/ebfd297c432615a8e2f038dd226549528d7ecfce))
* **ai-agent:** enable aionrs team capability via MCP injection ([18f25ec](https://github.com/xiayuanyin/aion_core/commit/18f25ec12fcd49bc239a4a52fd1783d3507e6da4))
* **ai-agent:** log every CLI detection + add doctor subcommand ([#285](https://github.com/xiayuanyin/aion_core/issues/285)) ([5ef6d0a](https://github.com/xiayuanyin/aion_core/commit/5ef6d0a4d99345a502a9073dfdfa0d07cfa52a8c))
* **ai-agent:** route image attachments by model capability ([82c5bc1](https://github.com/xiayuanyin/aion_core/commit/82c5bc14bcb1fcf4396e033764732adbe63966ef))
* **ai-agent:** surface upstream 429 body in AgentSendError detail ([#591](https://github.com/xiayuanyin/aion_core/issues/591)) ([b8fe5b6](https://github.com/xiayuanyin/aion_core/commit/b8fe5b6f3c6f93f7b8fc730b658772da3f4f83fa))
* **ai-agent:** use responses api for gpt-5.6 ([cde4129](https://github.com/xiayuanyin/aion_core/commit/cde4129521340fe71e67a40f17f0d00a2935fe2a))
* **ai-agent:** use responses api for gpt-5.6 ([15bbb1e](https://github.com/xiayuanyin/aion_core/commit/15bbb1eeb97fa619bea14733958fc9623100a274))
* **aionrs:** consume attached files as structured content blocks ([0f8c7d1](https://github.com/xiayuanyin/aion_core/commit/0f8c7d1b681d35fdf55b857948978fc28444bf61))
* **aionrs:** expose slash commands API ([c9d30ca](https://github.com/xiayuanyin/aion_core/commit/c9d30ca63b7840fd997048bb4ffbe1b4976eb63c))
* **aionrs:** expose slash commands via get_slash_commands() ([e6e120a](https://github.com/xiayuanyin/aion_core/commit/e6e120a883c522a045360325b325a81033c9d28d))
* **aionrs:** inline image attachments for Aion CLI ([aff870b](https://github.com/xiayuanyin/aion_core/commit/aff870bb1d3328abfc3d0c24d8898f0e148790ab))
* **aionrs:** inline image attachments for Aion CLI ([e4e5e9b](https://github.com/xiayuanyin/aion_core/commit/e4e5e9b26867b59f8c66a11b1fc80abc0029b651))
* align team shared workspace resolution ([#475](https://github.com/xiayuanyin/aion_core/issues/475)) ([06b8e71](https://github.com/xiayuanyin/aion_core/commit/06b8e71572045ddac640bda38e2733dd9ad35f18))
* **app:** change database filename to aionui-backend.db ([e30f544](https://github.com/xiayuanyin/aion_core/commit/e30f5445cdcda4e2e9e3c83cd0a185bbd34bfc3e))
* **app:** copy legacy database before init on first run ([63b3b8c](https://github.com/xiayuanyin/aion_core/commit/63b3b8ca31cb130a8e1e84e7dc58d07652b4d523))
* **assistant:** add built-in AionUi self-management assistant ([#474](https://github.com/xiayuanyin/aion_core/issues/474)) ([eea941e](https://github.com/xiayuanyin/aion_core/commit/eea941e344b9dd11338393078c63bddcc532137e))
* **assistant:** allow overriding preset_agent_type on built-in assistants ([01358fa](https://github.com/xiayuanyin/aion_core/commit/01358fadd998b5cdda2e1b7df4cbb9fb426108da))
* **assistant:** allow overriding preset_agent_type on built-in assistants ([49baa5e](https://github.com/xiayuanyin/aion_core/commit/49baa5e7e3a82c833d50315ac256ba9812a0000a))
* **assistant:** expand AionUi assistant into a butler with remote-access ([#481](https://github.com/xiayuanyin/aion_core/issues/481)) ([794c21a](https://github.com/xiayuanyin/aion_core/commit/794c21a589ef24de6f3fa03a628bb47e7958d6fe))
* **assistant:** persist thought-level defaults ([#574](https://github.com/xiayuanyin/aion_core/issues/574)) ([dd9f299](https://github.com/xiayuanyin/aion_core/commit/dd9f29967270f4e7263484532fad3b2199ba1894))
* **assistant:** 官方助手默认关闭 + 固定顺序 + 一次性重置迁移 ([#567](https://github.com/xiayuanyin/aion_core/issues/567)) ([3e30b02](https://github.com/xiayuanyin/aion_core/commit/3e30b02e021642ea116b68abc441bca0b91c60f3))
* **auth:** add local-only /api/webui/* routes + admin-seeded system user ([08fc161](https://github.com/xiayuanyin/aion_core/commit/08fc16168f0f5e721cb8223c7aac15b42b832b1c))
* **auth:** add local-only /api/webui/* routes + admin-seeded system user ([c8edae6](https://github.com/xiayuanyin/aion_core/commit/c8edae6269653f3bd48cd27a24ea8d5cf89b855e))
* bundle managed node and ACP runtime resources ([#403](https://github.com/xiayuanyin/aion_core/issues/403)) ([6aafd57](https://github.com/xiayuanyin/aion_core/commit/6aafd572178ff4197b7a356db48fea8250d50318))
* **cli:** add --work-dir argument for conversation workspaces ([ed2d394](https://github.com/xiayuanyin/aion_core/commit/ed2d3942582245b243d7ab0e25175528a5db7d40))
* **cli:** add --work-dir argument for conversation workspaces ([fdfbbf5](https://github.com/xiayuanyin/aion_core/commit/fdfbbf5e36658f6aa4454f3cb5c38332a93f544b))
* **cli:** add agent-facing config and diagnose commands ([#595](https://github.com/xiayuanyin/aion_core/issues/595)) ([e80177e](https://github.com/xiayuanyin/aion_core/commit/e80177e95a380c89f833b4302ff24b7359ac2a58))
* **cli:** canonicalize CLI and bootstrap boundary errors ([#417](https://github.com/xiayuanyin/aion_core/issues/417)) ([9ddf82e](https://github.com/xiayuanyin/aion_core/commit/9ddf82e374f9f40fa5f7321fea54dca3a611f3c5))
* **config:** add conversation rename command ([#638](https://github.com/xiayuanyin/aion_core/issues/638)) ([a611553](https://github.com/xiayuanyin/aion_core/commit/a61155379ac031a161b210d4bdc297d009ba5a11))
* converge team mode runtime architecture ([#464](https://github.com/xiayuanyin/aion_core/issues/464)) ([abeb9a1](https://github.com/xiayuanyin/aion_core/commit/abeb9a184a280a8da1f9089a90f7be2db3c94af4))
* **conversation:** add cursor pagination for messages ([#515](https://github.com/xiayuanyin/aion_core/issues/515)) ([ba76273](https://github.com/xiayuanyin/aion_core/commit/ba7627328ae8447afb7566e90cbb556fa381dff0))
* **conversation:** expose GET /api/conversations/active-count ([#243](https://github.com/xiayuanyin/aion_core/issues/243)) ([58a7b55](https://github.com/xiayuanyin/aion_core/commit/58a7b55f6cd808fe944ff0f1bfcb09c60b01e561))
* **conversation:** persist tool call events to messages table ([6ca5211](https://github.com/xiayuanyin/aion_core/commit/6ca52119c318192403c5ac103b36bcb4c7b633ae))
* **conversation:** persist tool call events to messages table ([70b59b8](https://github.com/xiayuanyin/aion_core/commit/70b59b8014585061ff004d814e8a6dcc6a35d9f4))
* **conversation:** type-aware model routing + seed acp_session runtime ([#240](https://github.com/xiayuanyin/aion_core/issues/240)) ([6797d60](https://github.com/xiayuanyin/aion_core/commit/6797d600af65e289197965bf4d0dd886f58c2159))
* **cron:** deduplicate and protect scheduled executions ([#601](https://github.com/xiayuanyin/aion_core/issues/601)) ([b189de0](https://github.com/xiayuanyin/aion_core/commit/b189de0e0a5a3cb837de8b0237ce6e7f96c8aa3d))
* **db:** add maybe_copy_legacy_database for safe upgrade path ([d2ba388](https://github.com/xiayuanyin/aion_core/commit/d2ba388809fd3ec06e597f29b81f1c1381dbd544))
* **db:** safe database migration via copy-then-migrate ([762f8b2](https://github.com/xiayuanyin/aion_core/commit/762f8b291b94b4af8498bb76c4021cb39edd2762))
* **diagnostics:** expand feedback runtime evidence ([#612](https://github.com/xiayuanyin/aion_core/issues/612)) ([08426dc](https://github.com/xiayuanyin/aion_core/commit/08426dcf83290577a2b8ef706bc3c1d21354425c))
* enforce agent runtime policy and turn-aware state ([#436](https://github.com/xiayuanyin/aion_core/issues/436)) ([b7099fe](https://github.com/xiayuanyin/aion_core/commit/b7099fee0cd2488326957dfe7811bf87e15aabb7))
* enforce external ACP runtime policy ([7390000](https://github.com/xiayuanyin/aion_core/commit/739000054dbf85ced95c104444471d08e0312d39))
* enforce TeamRun ownership for agent turns ([#483](https://github.com/xiayuanyin/aion_core/issues/483)) ([4cc168a](https://github.com/xiayuanyin/aion_core/commit/4cc168a57c07879310d9e4fe8b8050735f35155a))
* **file:** add GET /api/fs/browse shallow host-file picker ([#235](https://github.com/xiayuanyin/aion_core/issues/235)) ([1034d22](https://github.com/xiayuanyin/aion_core/commit/1034d22083df2b5c17fb430e610db8ea3f807347))
* **idle:** extend idle-cleanup timeouts and make them env-configurable ([#643](https://github.com/xiayuanyin/aion_core/issues/643)) ([a719bc7](https://github.com/xiayuanyin/aion_core/commit/a719bc74a5587097246689c683079488fba73007))
* **logging:** integrate aionrs independent file logging ([da16d97](https://github.com/xiayuanyin/aion_core/commit/da16d97975202808c2b24ea884dff6f43c2de4d3))
* **logging:** integrate aionrs independent file logging ([dc950c8](https://github.com/xiayuanyin/aion_core/commit/dc950c8781b3f5fdc4aaa435c9f69e27b079ccb2))
* **mcp:** support session scoped MCP injection ([#363](https://github.com/xiayuanyin/aion_core/issues/363)) ([2974f47](https://github.com/xiayuanyin/aion_core/commit/2974f47346056ef5483fe3e9c39d58d63f714ae7))
* remove single-chat team upgrade path ([#524](https://github.com/xiayuanyin/aion_core/issues/524)) ([5c60df3](https://github.com/xiayuanyin/aion_core/commit/5c60df38473b5a566e4f3598f6a36dfb63f52bab))
* **runtime:** add subprocess Builder; migrate ai-agent and mcp spawns ([#195](https://github.com/xiayuanyin/aion_core/issues/195)) ([07f6d81](https://github.com/xiayuanyin/aion_core/commit/07f6d81e2bd4edc8471921c6cdde365282a99651))
* **runtime:** enhance PATH at startup for all downstream spawn sites ([#193](https://github.com/xiayuanyin/aion_core/issues/193)) ([1e3e00e](https://github.com/xiayuanyin/aion_core/commit/1e3e00e54bc3995251899efd1ee8330106b2d7fc))
* **runtime:** full shell-style command in spawn logs ([#278](https://github.com/xiayuanyin/aion_core/issues/278)) ([dd51616](https://github.com/xiayuanyin/aion_core/commit/dd516165ae9e22fcb0573ae9d8d3aa094e54cff2))
* **stt:** streaming transcription proxy over websocket ([#455](https://github.com/xiayuanyin/aion_core/issues/455)) ([1c19a8b](https://github.com/xiayuanyin/aion_core/commit/1c19a8b9a80be665d30310071c0c12bc95881c11))
* support WeCom file attachments ([5b4cb07](https://github.com/xiayuanyin/aion_core/commit/5b4cb07f801299e37e6870ea79b88fc6536b91a0))
* **system:** add feedback diagnostics report ([#585](https://github.com/xiayuanyin/aion_core/issues/585)) ([a3eb1e4](https://github.com/xiayuanyin/aion_core/commit/a3eb1e49396e715ce8464700dca5e50a966552ee))
* **team:** add CLI fallback collaboration transport ([#629](https://github.com/xiayuanyin/aion_core/issues/629)) ([bbb6fec](https://github.com/xiayuanyin/aion_core/commit/bbb6fec08f7fd818375664bc5bf206805013f7d0))
* **team:** add run state snapshot endpoint ([#549](https://github.com/xiayuanyin/aion_core/issues/549)) ([2c7cfe8](https://github.com/xiayuanyin/aion_core/commit/2c7cfe8a3eb49c8be790a7733ccad2f8a49f19bd))
* **team:** centralize team MCP prompt governance ([#490](https://github.com/xiayuanyin/aion_core/issues/490)) ([5485a95](https://github.com/xiayuanyin/aion_core/commit/5485a95897c327dc2c8f4f1c44cfab7c6f628905))
* **team:** dynamic agent type list + fix warmup race skipping preset_context ([#208](https://github.com/xiayuanyin/aion_core/issues/208)) ([2384a23](https://github.com/xiayuanyin/aion_core/commit/2384a23281aa6ac375ef4ba1d94b6df5d05b408b))
* **team:** support queued team_send_message semantics ([#479](https://github.com/xiayuanyin/aion_core/issues/479)) ([a57a079](https://github.com/xiayuanyin/aion_core/commit/a57a079136cbe8a5fafa0ff4d8660bbfa28a07c5))
* **team:** support slot-scoped team pause and wake flow ([#472](https://github.com/xiayuanyin/aion_core/issues/472)) ([398b20f](https://github.com/xiayuanyin/aion_core/commit/398b20f2279fc7b042ae65cbbe5658be953e6f31))
* update model versions and add support for deepseek V4 vision patterns ([58bb203](https://github.com/xiayuanyin/aion_core/commit/58bb203ead3f1af459584bc1c98ebf7ce42268e6))


### Bug Fixes

* **acp:** apply AvailableCommands event to session aggregate ([#270](https://github.com/xiayuanyin/aion_core/issues/270)) ([a46b561](https://github.com/xiayuanyin/aion_core/commit/a46b561b20421a59fd73e9629ef452c624781ef2))
* **acp:** confirm legacy mode/model on ACK instead of awaiting observed update ([#635](https://github.com/xiayuanyin/aion_core/issues/635)) ([ded7a5c](https://github.com/xiayuanyin/aion_core/commit/ded7a5ce7951cad942852488f30382ed7fb909da))
* **acp:** load user MCP servers and emit empty-finish diagnostic (ELECTRON-1JG) ([#327](https://github.com/xiayuanyin/aion_core/issues/327)) ([2a6c2e9](https://github.com/xiayuanyin/aion_core/commit/2a6c2e943683a72eebaaa1d608be10fe5f795634))
* **acp:** normalize Codex full-access mode ([#608](https://github.com/xiayuanyin/aion_core/issues/608)) ([df51fcf](https://github.com/xiayuanyin/aion_core/commit/df51fcf77aa541c78c6eb6af4e987eab92b1ff07))
* **acp:** persist runtime model and mode into assistant preferences ([#482](https://github.com/xiayuanyin/aion_core/issues/482)) ([b9bcad9](https://github.com/xiayuanyin/aion_core/commit/b9bcad9d2deb94281a084c4b43a9f09c477444ed))
* **acp:** prefer config options catalogs ([#425](https://github.com/xiayuanyin/aion_core/issues/425)) ([9d89cc9](https://github.com/xiayuanyin/aion_core/commit/9d89cc9b46cc684a04c2cb9452ed9d792bd3a8de))
* **acp:** preserve confirmed model selection ([#437](https://github.com/xiayuanyin/aion_core/issues/437)) ([e16e11f](https://github.com/xiayuanyin/aion_core/commit/e16e11fa1e6ff9bd6449a8b1bc6bcfb5859fc865))
* **acp:** preserve selectors for partial config snapshots ([#548](https://github.com/xiayuanyin/aion_core/issues/548)) ([0cb3a9a](https://github.com/xiayuanyin/aion_core/commit/0cb3a9a5925b273ec1b6610c04469f8724ad14fb))
* **acp:** recover dead ACP connections ([#487](https://github.com/xiayuanyin/aion_core/issues/487)) ([8264873](https://github.com/xiayuanyin/aion_core/commit/8264873c3879a199201d3700a9f7a9a7b7ba1534))
* **acp:** stabilize mode and model source of truth ([#409](https://github.com/xiayuanyin/aion_core/issues/409)) ([300bb1e](https://github.com/xiayuanyin/aion_core/commit/300bb1eba0c30207918dc9b23a2934f3542d2fe4))
* **acp:** track close reason to avoid reporting user cancel as crash (ELECTRON-1K0) ([#328](https://github.com/xiayuanyin/aion_core/issues/328)) ([9506f9d](https://github.com/xiayuanyin/aion_core/commit/9506f9d1666e26b8659e3339dbfa8f13568f54ce))
* **agent:** adapt aionrs compat API ([#528](https://github.com/xiayuanyin/aion_core/issues/528)) ([f4ad432](https://github.com/xiayuanyin/aion_core/commit/f4ad4326342c7c93abaa1da121683d472028c2f5))
* **agent:** add provider health check probe ([#358](https://github.com/xiayuanyin/aion_core/issues/358)) ([d3a8702](https://github.com/xiayuanyin/aion_core/commit/d3a8702c2c98a78085a24860bb20a15b1682dfda))
* **agent:** align unchecked availability with team runtime selection ([#571](https://github.com/xiayuanyin/aion_core/issues/571)) ([f80b0ce](https://github.com/xiayuanyin/aion_core/commit/f80b0ceac3b603c3b58e0f1a25feb31a0261f7c8))
* **agent:** avoid full availability refresh on reads ([#566](https://github.com/xiayuanyin/aion_core/issues/566)) ([1ffb7aa](https://github.com/xiayuanyin/aion_core/commit/1ffb7aa6a0fcb55a4c8966b965133ab0ace9e8b2))
* **agent:** classify ACP and provider errors ([#518](https://github.com/xiayuanyin/aion_core/issues/518)) ([ef573d0](https://github.com/xiayuanyin/aion_core/commit/ef573d0071acc0c9f4671da8a4029abea8ec2a57))
* **agent:** classify Bedrock 'model identifier is invalid' as model-not-found (AIO-12) ([#377](https://github.com/xiayuanyin/aion_core/issues/377)) ([07dc3ac](https://github.com/xiayuanyin/aion_core/commit/07dc3ac8b2fae8962e8a7e31a223875669e11ba1))
* **agent:** expose aionrs mode config option ([#501](https://github.com/xiayuanyin/aion_core/issues/501)) ([d1a360d](https://github.com/xiayuanyin/aion_core/commit/d1a360de17114dad5e1834ab2fc8531672ffd17b))
* **agent:** expose runtime catalogs from metadata ([#523](https://github.com/xiayuanyin/aion_core/issues/523)) ([d9c2502](https://github.com/xiayuanyin/aion_core/commit/d9c2502e499a6794476fcdbe63a14573b4fa81d0))
* **agent:** guard internal Aion CLI command overrides ([#538](https://github.com/xiayuanyin/aion_core/issues/538)) ([f141233](https://github.com/xiayuanyin/aion_core/commit/f141233b0cbe03a8f8ae61372d2a8fdabb9cb81c))
* **agent:** make codex sandbox sync non-fatal ([#370](https://github.com/xiayuanyin/aion_core/issues/370)) ([8916faa](https://github.com/xiayuanyin/aion_core/commit/8916faa9bc69ff1959aef2db83febb7c03f1441b))
* **agent:** preserve ACP error cause detail ([#581](https://github.com/xiayuanyin/aion_core/issues/581)) ([220f682](https://github.com/xiayuanyin/aion_core/commit/220f6823c1d29fde640427cfdd77de7e981758b2))
* **agent:** preserve process-group cleanup after leader exit ([#369](https://github.com/xiayuanyin/aion_core/issues/369)) ([73d4fb4](https://github.com/xiayuanyin/aion_core/commit/73d4fb4f4e4647352ba3dcac07e4a6b277e46c7b))
* **agent:** project available commands in management rows ([#579](https://github.com/xiayuanyin/aion_core/issues/579)) ([689ee8f](https://github.com/xiayuanyin/aion_core/commit/689ee8f91cbabd7e57c4e882f86c1ceec167e36d))
* **agent:** send non-empty clientInfo in ACP initialize handshake ([#471](https://github.com/xiayuanyin/aion_core/issues/471)) ([5a8df22](https://github.com/xiayuanyin/aion_core/commit/5a8df22fd9db4b77ec0c7e9870aec78db6d7bec7))
* **agents:** honor login PATH and validate builtin CLIs ([#622](https://github.com/xiayuanyin/aion_core/issues/622)) ([3190be1](https://github.com/xiayuanyin/aion_core/commit/3190be1fae7e15be98f5f963e57a54fdee87029e))
* **agent:** support aionrs 0.1.31 ([#503](https://github.com/xiayuanyin/aion_core/issues/503)) ([d612602](https://github.com/xiayuanyin/aion_core/commit/d612602aa3bfa88bef60a85a1aa5cb40634055fd))
* **agent:** surface OpenClaw Gateway unreachable errors ([#498](https://github.com/xiayuanyin/aion_core/issues/498)) ([90d34ae](https://github.com/xiayuanyin/aion_core/commit/90d34aee81d484c949b3fc4358447095752e2b8d))
* **agent:** tighten send_error classifier (AIO-87, AIO-89, AIO-90) ([#375](https://github.com/xiayuanyin/aion_core/issues/375)) ([d9a2f76](https://github.com/xiayuanyin/aion_core/commit/d9a2f763d14ec642c09f3aef5a2d8b716f4b0648))
* **agent:** validate managed ACP platform binaries ([#462](https://github.com/xiayuanyin/aion_core/issues/462)) ([651c79f](https://github.com/xiayuanyin/aion_core/commit/651c79f0ec0e07009f637ebb2afa14de47c95ba3))
* **agent:** wait for task shutdown during clear ([#446](https://github.com/xiayuanyin/aion_core/issues/446)) ([bea814e](https://github.com/xiayuanyin/aion_core/commit/bea814e08ddb96ccb5d09a8016e92d179a2f318a))
* **ai-agent:** auto approve team mcp permissions ([#447](https://github.com/xiayuanyin/aion_core/issues/447)) ([096953e](https://github.com/xiayuanyin/aion_core/commit/096953e038aaa1f07333bbd6751ee927bf129e60))
* **ai-agent:** cap provider health check tokens ([1021b63](https://github.com/xiayuanyin/aion_core/commit/1021b631aa1b7b97d7b70d18284df21bf29dda41))
* **ai-agent:** force-kill ACP processes on Windows (ELECTRON-1E9) ([#303](https://github.com/xiayuanyin/aion_core/issues/303)) ([e60fdd3](https://github.com/xiayuanyin/aion_core/commit/e60fdd31332512398715ed056a7f60eeee42a752))
* **ai-agent:** ignore max token limits for aionui requests ([0121c24](https://github.com/xiayuanyin/aion_core/commit/0121c24d70f4a5a63e79ee71869aee34e6b62506))
* **ai-agent:** ignore max token limits for aionui requests ([8bdf305](https://github.com/xiayuanyin/aion_core/commit/8bdf305e9a94d1a5aa8402424e8ef8d540eeb66c))
* **ai-agent:** make find_native_claude cross-platform (ELECTRON-1CG) ([#299](https://github.com/xiayuanyin/aion_core/issues/299)) ([fda9239](https://github.com/xiayuanyin/aion_core/commit/fda92398caa9384d8f0cdc11cf0a3616047448af))
* **ai-agent:** negotiate OpenClaw protocol v3..v4 ([#288](https://github.com/xiayuanyin/aion_core/issues/288)) ([dfeece0](https://github.com/xiayuanyin/aion_core/commit/dfeece0e6a465093090c0efdfa1f5aa93d9fa6e8))
* **ai-agent:** pin image-capable aionrs revision ([6687805](https://github.com/xiayuanyin/aion_core/commit/6687805f09042b9a34b4e5ac22900374358d2671))
* **ai-agent:** prevent stuck session after ACP cancel ([#313](https://github.com/xiayuanyin/aion_core/issues/313)) ([3a84bfe](https://github.com/xiayuanyin/aion_core/commit/3a84bfec1bfffd589d091efdd7b157ea1c3b2960))
* **ai-agent:** rebuild ACP session when CLI rejects stale sid (ELECTRON-1HQ) ([#320](https://github.com/xiayuanyin/aion_core/issues/320)) ([b4d8a75](https://github.com/xiayuanyin/aion_core/commit/b4d8a7505e78c48ed26af364b6e13ad4302b4727))
* **ai-agent:** return 409 when remote WS not connected on cancel (ELECTRON-1CV) ([#302](https://github.com/xiayuanyin/aion_core/issues/302)) ([dc87f1c](https://github.com/xiayuanyin/aion_core/commit/dc87f1c37352be6cd820503ed4c38be4098d26ed))
* **ai-agent:** set default aionrs thinking cli args ([de240a4](https://github.com/xiayuanyin/aion_core/commit/de240a4435058bf349acd7897b2836cff49b884d))
* **ai-agent:** surface ACP startup crashes and accept work_dir paths (ELECTRON-1BT) ([#305](https://github.com/xiayuanyin/aion_core/issues/305)) ([7aa29a7](https://github.com/xiayuanyin/aion_core/commit/7aa29a78a2fa5013b9a4845217ba89d4b045822b))
* **ai-agent:** surface upstream ACP error messages without status prefix ([#268](https://github.com/xiayuanyin/aion_core/issues/268)) ([532f7e3](https://github.com/xiayuanyin/aion_core/commit/532f7e3bbee7e8389499f4d7bbda198c22363e13))
* **ai-agent:** trim stderr buffer at UTF-8 char boundary ([#443](https://github.com/xiayuanyin/aion_core/issues/443)) ([7380c7c](https://github.com/xiayuanyin/aion_core/commit/7380c7cdd3c08a51de397e6af32f22361199b592))
* **aionrs:** abort engine.run() on cancel ([9eeb0a8](https://github.com/xiayuanyin/aion_core/commit/9eeb0a8620d10a3e2de74fa9d37907f3c8ab043a))
* **aionrs:** abort engine.run() on cancel instead of only emitting events ([74024c3](https://github.com/xiayuanyin/aion_core/commit/74024c3af6a8277588c4dd28e8453e1822789e15))
* **aionrs:** adapt runtime guard config ([#510](https://github.com/xiayuanyin/aion_core/issues/510)) ([464f453](https://github.com/xiayuanyin/aion_core/commit/464f4533822c8959a4d0f4d4d81d2b998152498e))
* **aionrs:** classify engine errors structurally ([#494](https://github.com/xiayuanyin/aion_core/issues/494)) ([8552b0a](https://github.com/xiayuanyin/aion_core/commit/8552b0a30f0eb323d62032986919170c05374c6a))
* **aionrs:** default missing model protocol to openai ([be519dc](https://github.com/xiayuanyin/aion_core/commit/be519dcc73af8e274c8d6d7e06fa103cdd115eae))
* **aionrs:** drop malformed tool-call events ([#486](https://github.com/xiayuanyin/aion_core/issues/486)) ([67ffbd0](https://github.com/xiayuanyin/aion_core/commit/67ffbd03d3aa17a46b47d6eafe08277edaaacdc4))
* **aionrs:** drop orphaned tool_call history on session resume (ELECTRON-1HV, ELECTRON-1J6) ([#330](https://github.com/xiayuanyin/aion_core/issues/330)) ([880722f](https://github.com/xiayuanyin/aion_core/commit/880722fd3b2f4e37fa5654cc5ed210cddbfd14b5))
* **aionrs:** merge preset_rules into system_prompt for preset assistants ([90fa3fd](https://github.com/xiayuanyin/aion_core/commit/90fa3fda7ee32bcabe6d0272053efbf299b3b64e))
* **aionrs:** merge preset_rules into system_prompt for preset assistants ([fec4e4f](https://github.com/xiayuanyin/aion_core/commit/fec4e4f97ef0c9655110783d1d205b3bba1b7276))
* **aionrs:** pass bedrock credentials from DB to aion-agent config ([#223](https://github.com/xiayuanyin/aion_core/issues/223)) ([9a10a57](https://github.com/xiayuanyin/aion_core/commit/9a10a57021ef8944889b27aa12ec2d35be15eb8f))
* **aionrs:** preserve tool call correlation across aborts ([#335](https://github.com/xiayuanyin/aion_core/issues/335)) ([d65c8ed](https://github.com/xiayuanyin/aion_core/commit/d65c8ed49be4a558aff99e907e359264d6729d1c))
* **aionrs:** reset runtime status on new turn to unblock StreamRelay ([2820ecf](https://github.com/xiayuanyin/aion_core/commit/2820ecf9a1a0f81b51f26c05c0d841da7a9b5e64))
* **aionrs:** respect model protocol over base url ([10f3ce9](https://github.com/xiayuanyin/aion_core/commit/10f3ce97b569894d6e29edab9c661b9869198ef4))
* **aionrs:** second message stuck in processing state ([6181083](https://github.com/xiayuanyin/aion_core/commit/61810831ec89228188d8a7268f98f6078ff90442))
* **aionrs:** stop inferring anthropic v1 suffix ([ed8f26c](https://github.com/xiayuanyin/aion_core/commit/ed8f26c6a1e9474984602712349e0ad2961108c4))
* **aionrs:** use versioned anthropic path for custom providers ([e300395](https://github.com/xiayuanyin/aion_core/commit/e30039568edda6619dbf8da99c56d23157ca031c))
* **aionui-ai-agent:** classify aionrs API connection errors ([#389](https://github.com/xiayuanyin/aion_core/issues/389)) ([c3f16f7](https://github.com/xiayuanyin/aion_core/commit/c3f16f7453d061d0865cb7c61eca183a6d6e797f))
* **aionui-ai-agent:** strip HTML body from sanitized error detail (AIO-13) ([#380](https://github.com/xiayuanyin/aion_core/issues/380)) ([9fc5d8c](https://github.com/xiayuanyin/aion_core/commit/9fc5d8c088c644f771457bf50658ac7c6e98c1dc))
* **app:** bind backend before startup services ([#397](https://github.com/xiayuanyin/aion_core/issues/397)) ([1ae944c](https://github.com/xiayuanyin/aion_core/commit/1ae944cb4239e898f910118885df9dfa793aec54))
* **app:** reuse conversation service for channel messages ([#531](https://github.com/xiayuanyin/aion_core/issues/531)) ([dce8053](https://github.com/xiayuanyin/aion_core/commit/dce80538b1575a35e512f93b6da0a5b2ab7b89c4))
* **app:** stop backend when desktop exits ([#433](https://github.com/xiayuanyin/aion_core/issues/433)) ([d300235](https://github.com/xiayuanyin/aion_core/commit/d30023562bcb6d413f428fcb1dec412929a72ab3))
* **app:** update database_path test assertion to match new filename ([4bf0fc8](https://github.com/xiayuanyin/aion_core/commit/4bf0fc879f4d90018cada429efc067c65afd6b93))
* **app:** use process synchronize access for parent watcher ([#438](https://github.com/xiayuanyin/aion_core/issues/438)) ([95571f1](https://github.com/xiayuanyin/aion_core/commit/95571f1c9fcd69df6ec15d8f595178c4869c15d0))
* **assistant:** canonicalize rule file storage ([#625](https://github.com/xiayuanyin/aion_core/issues/625)) ([020a27a](https://github.com/xiayuanyin/aion_core/commit/020a27a77aeb2b5be7a2b4380aab8ae2686311c4))
* **assistant:** default agent_type to aionrs and resolve by provider (ELECTRON-1J1, ELECTRON-1KV) ([#325](https://github.com/xiayuanyin/aion_core/issues/325)) ([5c7fa04](https://github.com/xiayuanyin/aion_core/commit/5c7fa04bef47cf5bf2ea6badc66f723f0aafe1ec))
* **assistant:** expose auto-inject skills and preserve assistant rules ([#525](https://github.com/xiayuanyin/aion_core/issues/525)) ([f2e91fd](https://github.com/xiayuanyin/aion_core/commit/f2e91fde95ef3a84e43fbe22d71960d64686d3b0))
* **assistant:** filter generated assistants by installed agents ([#578](https://github.com/xiayuanyin/aion_core/issues/578)) ([5b7c366](https://github.com/xiayuanyin/aion_core/commit/5b7c366132006eb16e748e8fc5a0976da9a5b2a3))
* **assistant:** normalize avatar storage and identity ([#558](https://github.com/xiayuanyin/aion_core/issues/558)) ([155c278](https://github.com/xiayuanyin/aion_core/commit/155c278b7b603e8bf29e412295cec5ec50bb25fe))
* **assistant:** pin user_data_dir to runtime --data-dir ([#274](https://github.com/xiayuanyin/aion_core/issues/274)) ([0d49022](https://github.com/xiayuanyin/aion_core/commit/0d49022f90d7950e00e0dfdb60e389116177182d))
* **assistant:** preserve builtin override selections ([#535](https://github.com/xiayuanyin/aion_core/issues/535)) ([be4a81e](https://github.com/xiayuanyin/aion_core/commit/be4a81ef2927c0bedef3dbf22a69fc4e8f2ffd40))
* **assistant:** remove star office helper remnants ([#470](https://github.com/xiayuanyin/aion_core/issues/470)) ([eec23d9](https://github.com/xiayuanyin/aion_core/commit/eec23d9fed25765c43ca9f5f50df91cd53d01888))
* **assistant:** skip dirty assistant bootstrap records ([#615](https://github.com/xiayuanyin/aion_core/issues/615)) ([f48cbc7](https://github.com/xiayuanyin/aion_core/commit/f48cbc757f96e3595b00f4f81330dab958f41d28))
* **assistant:** stop legacy override sync from clobbering user toggles ([#634](https://github.com/xiayuanyin/aion_core/issues/634)) ([346700e](https://github.com/xiayuanyin/aion_core/commit/346700e1d62470f84eec94b1c58fd3516d1ea90e))
* **auth:** allow same-origin framing on office preview proxy routes ([#454](https://github.com/xiayuanyin/aion_core/issues/454)) ([3543dbd](https://github.com/xiayuanyin/aion_core/commit/3543dbdc0b8ca46682b84383d2b6c4aee9bdbdd6))
* **auth:** return 401 for login attempts against empty password_hash ([#225](https://github.com/xiayuanyin/aion_core/issues/225)) ([669e8ba](https://github.com/xiayuanyin/aion_core/commit/669e8ba258157591b9e86136388dca4456fe62ba)), closes [#224](https://github.com/xiayuanyin/aion_core/issues/224)
* **auth:** widen rate limiter test window to prevent CI flakiness ([b5f1d05](https://github.com/xiayuanyin/aion_core/commit/b5f1d05e13f0608a68eb4dbf2250d1431f112c82))
* **butler:** correct three breaking field mismatches + update rule to CLI model ([#607](https://github.com/xiayuanyin/aion_core/issues/607)) ([b02bce6](https://github.com/xiayuanyin/aion_core/commit/b02bce62e5b7d847960be8d98e9f3b8c8e163e2c))
* channel reply stream cold start ([#366](https://github.com/xiayuanyin/aion_core/issues/366)) ([b848ddf](https://github.com/xiayuanyin/aion_core/commit/b848ddff8fe5a973c67ee3c67187c6248d8c7455))
* **channel:** pass model via extra for non-aionrs conversations ([#298](https://github.com/xiayuanyin/aion_core/issues/298)) ([eb65dfe](https://github.com/xiayuanyin/aion_core/commit/eb65dfed2a9f2ea3d9cb11699c276ba76690c03e))
* **channel:** resolve WebSocket TLS panic from ambiguous CryptoProvider ([46038bd](https://github.com/xiayuanyin/aion_core/commit/46038bd487d6156925ad25b4d6f7021ea0312b84))
* **channel:** resolve WebSocket TLS panic from ambiguous CryptoProvider ([8e7f9f0](https://github.com/xiayuanyin/aion_core/commit/8e7f9f02a49e3fe72f738b4249add47be6c7f4ba))
* **channel:** reuse stored credentials when re-enabling a plugin ([#458](https://github.com/xiayuanyin/aion_core/issues/458)) ([3920c58](https://github.com/xiayuanyin/aion_core/commit/3920c583db1c6a49d3209f685a8fb510967ca48a))
* **channel:** rewrite WeChat plugin to match iLink Bot protocol ([59344cd](https://github.com/xiayuanyin/aion_core/commit/59344cd7f615237ce1cc3142c2483fc8c6b64747))
* **channel:** rewrite WeChat plugin to match iLink Bot protocol ([05a5276](https://github.com/xiayuanyin/aion_core/commit/05a5276a03b7789cd9e25f0118f84b762f1dcd32))
* **ci:** allow too_many_arguments on JobExecutor::new ([26918a0](https://github.com/xiayuanyin/aion_core/commit/26918a04b265a73298e216bda504b79bd47c852a))
* **ci:** auto-update Cargo.lock in release-please PR ([a3d6147](https://github.com/xiayuanyin/aion_core/commit/a3d614713cf0999f2471472dcfa6a8af4f9c0b8f))
* **ci:** auto-update Cargo.lock in release-please PR ([91f4495](https://github.com/xiayuanyin/aion_core/commit/91f44956ed24c8cb370d4ea71d9f62cd29e09fe7))
* **ci:** correct rsa dependency tree check logic ([2460714](https://github.com/xiayuanyin/aion_core/commit/24607148f570ab7b56558b1f277db5e61080bcb0))
* **ci:** ignore rsa false positive with compile-time guard ([301aa63](https://github.com/xiayuanyin/aion_core/commit/301aa635134e26040f83ab1b711ea244ef7ffa43))
* **ci:** remove openssl-sys dependency via git2 default-features ([5753a5a](https://github.com/xiayuanyin/aion_core/commit/5753a5ab8b0821cfce85ba4e8700aa140080486c))
* **ci:** remove openssl-sys dependency via git2 default-features ([e921a9b](https://github.com/xiayuanyin/aion_core/commit/e921a9bffae1197ac05b02bfda9b4002e2bae2e6))
* **ci:** resolve clippy warnings in aionui-api-types and aionui-realtime ([7b8c1c8](https://github.com/xiayuanyin/aion_core/commit/7b8c1c82976284b149195ae67707a1d62bf01f0f))
* **ci:** switch TLS backend from native-tls to rustls ([9f42a3a](https://github.com/xiayuanyin/aion_core/commit/9f42a3a609c8204f9dc4bda2a43d2ba6e85f6e84))
* **ci:** switch TLS backend from native-tls to rustls ([aa21990](https://github.com/xiayuanyin/aion_core/commit/aa2199010359c1f9316c3059f04ab6e30b212116))
* classify missing MCP launcher runtimes ([#387](https://github.com/xiayuanyin/aion_core/issues/387)) ([fd8c20c](https://github.com/xiayuanyin/aion_core/commit/fd8c20cc0f6f36805cf5acc1fee3c708296d661a))
* **conversation:** align workspace path availability handling ([#410](https://github.com/xiayuanyin/aion_core/issues/410)) ([30bc96b](https://github.com/xiayuanyin/aion_core/commit/30bc96b01632b2107279e81d641dfe020a3af873))
* **conversation:** avoid thinking/text segment id collision ([#342](https://github.com/xiayuanyin/aion_core/issues/342)) ([7aae690](https://github.com/xiayuanyin/aion_core/commit/7aae690063be683101b7bacc8e916e9d2b990ede))
* **conversation:** derive assistant runtime type from metadata ([#555](https://github.com/xiayuanyin/aion_core/issues/555)) ([236217d](https://github.com/xiayuanyin/aion_core/commit/236217d360ff67d0dcba906f287a34b954cb305d))
* **conversation:** kill agent process on conversation delete ([#267](https://github.com/xiayuanyin/aion_core/issues/267)) ([456ff32](https://github.com/xiayuanyin/aion_core/commit/456ff322845b96fd70583dcf1fc2fb12c2371030))
* **conversation:** partition temp workspaces and logs by date ([#560](https://github.com/xiayuanyin/aion_core/issues/560)) ([9bb1f33](https://github.com/xiayuanyin/aion_core/commit/9bb1f333065318c00da73c3a96f7fe92bea38d49))
* **conversation:** recover dead ACP turns after agent process loss ([#514](https://github.com/xiayuanyin/aion_core/issues/514)) ([e0ce4f4](https://github.com/xiayuanyin/aion_core/commit/e0ce4f4b67c44dff196d122216bd81bb42ca9ea9))
* **conversation:** unify provider/model resolution across send/cron paths (ELECTRON-1HX, ELECTRON-1HM) ([#326](https://github.com/xiayuanyin/aion_core/issues/326)) ([71e275a](https://github.com/xiayuanyin/aion_core/commit/71e275ae3295d88c9da5eacf9f959d4683b4043d))
* **conversation:** upsert streaming tool calls (AIO-30) ([#484](https://github.com/xiayuanyin/aion_core/issues/484)) ([a0b3737](https://github.com/xiayuanyin/aion_core/commit/a0b3737bf6a60c6f5483d4112dc4f4f733a9e6fa))
* **conversation:** use merge strategy for tool call updates to preserve input fields ([ed7568a](https://github.com/xiayuanyin/aion_core/commit/ed7568abb4a62e43dee22b972544c5f8450ed90a))
* **cron:** add kill_and_wait to StubTaskManager in service_integration test ([07b9d7b](https://github.com/xiayuanyin/aion_core/commit/07b9d7b57edc4345185f3b36966fb04dbc8e39cb))
* **cron:** apply custom assistant rules in scheduled runs ([#495](https://github.com/xiayuanyin/aion_core/issues/495)) ([3840b77](https://github.com/xiayuanyin/aion_core/commit/3840b77f4f4dc26b58481868507e07e13fb9fbd1))
* **cron:** enforce full-auto mode for scheduled tasks ([#576](https://github.com/xiayuanyin/aion_core/issues/576)) ([cf0a9bd](https://github.com/xiayuanyin/aion_core/commit/cf0a9bd88ac295fe8b40a6c1f9f21174b574718d))
* **cron:** lazy-bind existing jobs and tighten orphan cleanup ([#249](https://github.com/xiayuanyin/aion_core/issues/249)) ([da9ba8f](https://github.com/xiayuanyin/aion_core/commit/da9ba8fe9ddc48abb3e52090874f1d54352becee))
* **cron:** lock team cron execution mode ([#562](https://github.com/xiayuanyin/aion_core/issues/562)) ([56f3873](https://github.com/xiayuanyin/aion_core/commit/56f38734844164707782b795627a8d65ff1b3c16))
* **cron:** preserve existing conversation jobs across lifecycle changes ([#572](https://github.com/xiayuanyin/aion_core/issues/572)) ([fa4217a](https://github.com/xiayuanyin/aion_core/commit/fa4217a6d4ba0cde4d4c7d0d5460969b94eb6c4a))
* **cron:** restore create command heading ([#547](https://github.com/xiayuanyin/aion_core/issues/547)) ([1a30f77](https://github.com/xiayuanyin/aion_core/commit/1a30f7710de2c98856f7256811543c1121dddc76))
* **cron:** retry busy jobs from runtime state ([#459](https://github.com/xiayuanyin/aion_core/issues/459)) ([9918058](https://github.com/xiayuanyin/aion_core/commit/9918058788e07508ee61fc841e4c85cf757b8bb6))
* **cron:** route skill scheduling through helper ([#553](https://github.com/xiayuanyin/aion_core/issues/553)) ([c57970f](https://github.com/xiayuanyin/aion_core/commit/c57970fed387ba895dd934f85c4c59af63da6cfa))
* **cron:** run jobs through conversation service ([#546](https://github.com/xiayuanyin/aion_core/issues/546)) ([b36fb5c](https://github.com/xiayuanyin/aion_core/commit/b36fb5c471b19edefd0b63dc2acf3e3d4c2c52ae))
* **cron:** validate aionrs agent_config and scope model to aionrs ([#242](https://github.com/xiayuanyin/aion_core/issues/242)) ([262758b](https://github.com/xiayuanyin/aion_core/commit/262758b8f13579d58f46140c2b4e2c50dedb4fe1))
* **database:** require explicit corrupted database recovery ([#563](https://github.com/xiayuanyin/aion_core/issues/563)) ([203bd1b](https://github.com/xiayuanyin/aion_core/commit/203bd1b574438cf730c351879a773a82548b972c))
* **db:** cast REAL timestamps to INTEGER in conversations table ([#275](https://github.com/xiayuanyin/aion_core/issues/275)) ([92e5fa9](https://github.com/xiayuanyin/aion_core/commit/92e5fa9f75065b85b5533476d0fbb836b0145b4e))
* **db:** prevent data loss in migration 002 table rebuilds ([563f145](https://github.com/xiayuanyin/aion_core/commit/563f145e1953499a16dc1660cb488e567b5254ac))
* **db:** prevent data loss in migration 002 table rebuilds ([abda366](https://github.com/xiayuanyin/aion_core/commit/abda3660855b272eb310bf3f5688bb9935c58345))
* **db:** repair legacy handoff schema drift ([#516](https://github.com/xiayuanyin/aion_core/issues/516)) ([292e5f2](https://github.com/xiayuanyin/aion_core/commit/292e5f2d6fc727f41f4164d5f51cfa37c103b060))
* **db:** serialize migrations with fs2 file lock to avoid concurrent race (ELECTRON-1KK) ([#329](https://github.com/xiayuanyin/aion_core/issues/329)) ([8550851](https://github.com/xiayuanyin/aion_core/commit/85508518b1df99b48d9ea09f474ed4d64437e8af))
* **deps:** eliminate rustls-webpki 0.101.7 vulnerability ([614741f](https://github.com/xiayuanyin/aion_core/commit/614741f14b2ac5fbef521bfbac79b0f17a135f1d))
* **deps:** update quinn-proto for RustSec advisory ([#508](https://github.com/xiayuanyin/aion_core/issues/508)) ([05df6f7](https://github.com/xiayuanyin/aion_core/commit/05df6f7c2d924b94d1514bcee4ff835ea0e0b0fb))
* enforce workspace path whitespace errors across create and runtime ([#381](https://github.com/xiayuanyin/aion_core/issues/381)) ([9448a36](https://github.com/xiayuanyin/aion_core/commit/9448a36cec456648bd87a680e9dc84083038a63a))
* **error:** canonicalize boundary errors ([#415](https://github.com/xiayuanyin/aion_core/issues/415)) ([84e04e1](https://github.com/xiayuanyin/aion_core/commit/84e04e122dad19eee712af29d3b5bd3f631a6fe1))
* expose managed resource preparation failure details ([#430](https://github.com/xiayuanyin/aion_core/issues/430)) ([e010024](https://github.com/xiayuanyin/aion_core/commit/e010024fce3975fe5f6930c24377bde9f636b55b))
* **extension:** fall back to directory copy when Windows symlink fails (Sentry I1) ([#331](https://github.com/xiayuanyin/aion_core/issues/331)) ([d65a0a1](https://github.com/xiayuanyin/aion_core/commit/d65a0a13449f0941a68adbeae950f094e2545bfe))
* **file:** lazy load browse roots ([#406](https://github.com/xiayuanyin/aion_core/issues/406)) ([668c562](https://github.com/xiayuanyin/aion_core/commit/668c5623ffd30243cb0ed72e670eecb578fb22cc))
* **file:** raise paste-image body limit to 100MB ([#232](https://github.com/xiayuanyin/aion_core/issues/232)) ([6460b24](https://github.com/xiayuanyin/aion_core/commit/6460b24be0292c127aab8823fd710acfdb794269))
* **file:** strip Windows verbatim prefix from /api/fs/browse paths ([#453](https://github.com/xiayuanyin/aion_core/issues/453)) ([f8c3f95](https://github.com/xiayuanyin/aion_core/commit/f8c3f950f9897c4e13ae7bb1dbb7816017b86480))
* **file:** trust local workspace roots for fs routes ([#527](https://github.com/xiayuanyin/aion_core/issues/527)) ([8e6f32f](https://github.com/xiayuanyin/aion_core/commit/8e6f32fe1eda91177d794dca80c87cff3cd970fa))
* handle Hermes yolo fallback correctly ([#428](https://github.com/xiayuanyin/aion_core/issues/428)) ([e10d264](https://github.com/xiayuanyin/aion_core/commit/e10d26460ac6dabf292f8b1edd7eeb1c1ffd5cad))
* harden ACP image path handling ([#477](https://github.com/xiayuanyin/aion_core/issues/477)) ([c79b5a8](https://github.com/xiayuanyin/aion_core/commit/c79b5a8a010fee82219579873a062bcca5c71fc2))
* harden managed ACP bundle preparation and builtin CLI availability ([#426](https://github.com/xiayuanyin/aion_core/issues/426)) ([e0121f9](https://github.com/xiayuanyin/aion_core/commit/e0121f938e0160f48d2f57e9205f78bf31b92233))
* isolate ACP cancel turn completion ([#461](https://github.com/xiayuanyin/aion_core/issues/461)) ([ea01ee6](https://github.com/xiayuanyin/aion_core/commit/ea01ee6849d66dad698fee48f6374233d23985ae))
* load skills in custom workspaces ([#506](https://github.com/xiayuanyin/aion_core/issues/506)) ([d73c398](https://github.com/xiayuanyin/aion_core/commit/d73c39855c1863e0606aedcb6c4ef8ebffeec8cc))
* **managed-resources:** emit bundled resource manifest ([#617](https://github.com/xiayuanyin/aion_core/issues/617)) ([64b5062](https://github.com/xiayuanyin/aion_core/commit/64b506239639c632eb5f6acb4495e58e74c64167))
* **mcp:** clean up stdio test process trees ([#368](https://github.com/xiayuanyin/aion_core/issues/368)) ([3481956](https://github.com/xiayuanyin/aion_core/commit/3481956d4c7e2148302d9f31ecef5a88357c38e8))
* **mcp:** fix OpenAI schema rejection for no-arg team-guide tools ([#222](https://github.com/xiayuanyin/aion_core/issues/222)) ([9ef51b9](https://github.com/xiayuanyin/aion_core/commit/9ef51b9002863b42472ec78ba87159ad414623ca))
* **mcp:** support aionrs config path subcommand with legacy fallback ([#568](https://github.com/xiayuanyin/aion_core/issues/568)) ([72cfba1](https://github.com/xiayuanyin/aion_core/commit/72cfba1909d663117615a595316804c7707bdfd3))
* **model_fetcher:** extract first key from multi-line api_key for HTTP requests ([#593](https://github.com/xiayuanyin/aion_core/issues/593)) ([1161647](https://github.com/xiayuanyin/aion_core/commit/116164756544306ef8ac257106a03e665c85cf3d))
* **office:** fetch officecli installer from official mirror before GitHub ([#463](https://github.com/xiayuanyin/aion_core/issues/463)) ([08fbc6f](https://github.com/xiayuanyin/aion_core/commit/08fbc6f12d154d5419ae1b092a1a9352ee64250e))
* **office:** probe star-office preferred_url host as given ([#456](https://github.com/xiayuanyin/aion_core/issues/456)) ([3c2149c](https://github.com/xiayuanyin/aion_core/commit/3c2149ca92aad8a0e19fae0d8083083500f60267))
* **office:** resolve officecli shim from node_modules/.bin after npm prefix install ([#440](https://github.com/xiayuanyin/aion_core/issues/440)) ([2fe76ee](https://github.com/xiayuanyin/aion_core/commit/2fe76eebbaab1d323b4f81acaff8187a0c00bac7))
* **office:** restore OfficeCLI installer resolution ([#444](https://github.com/xiayuanyin/aion_core/issues/444)) ([009e133](https://github.com/xiayuanyin/aion_core/commit/009e133e9e914556a579f27a3671fb5ff47333f7))
* **office:** stabilize flaky port_timeout_on_no_listener test ([30df119](https://github.com/xiayuanyin/aion_core/commit/30df119eec0ae5b125b2613d4573b6432ed42094))
* prepare managed acp tools locally without cdn ([#408](https://github.com/xiayuanyin/aion_core/issues/408)) ([2a48ae3](https://github.com/xiayuanyin/aion_core/commit/2a48ae34a498ff0e5bd37d0eedee81d2ea7d0154))
* preserve ACP config catalogs on resume ([#570](https://github.com/xiayuanyin/aion_core/issues/570)) ([a9c1955](https://github.com/xiayuanyin/aion_core/commit/a9c19553bad1da3283f5dfad1972cd1ed1992546))
* preserve assistant snapshot and skill wiring for cron ([#473](https://github.com/xiayuanyin/aion_core/issues/473)) ([2d47d8c](https://github.com/xiayuanyin/aion_core/commit/2d47d8cca71c4d0fdc3d1c2b93916c03b8c3b42c))
* preserve cron timezone on legacy schedule updates ([#344](https://github.com/xiayuanyin/aion_core/issues/344)) ([6328b76](https://github.com/xiayuanyin/aion_core/commit/6328b7683133a6f74e87add6c11386ebbb0dad49))
* preserve Linux GLIBC baselines ([#573](https://github.com/xiayuanyin/aion_core/issues/573)) ([ab6e227](https://github.com/xiayuanyin/aion_core/commit/ab6e227504c40f78823988d4c10af8fd153cc47c))
* **provider:** allow empty base_url in update for bedrock ([9fb472c](https://github.com/xiayuanyin/aion_core/commit/9fb472c1ec523fcf78cb2a9e19fafcf520fab357))
* **provider:** allow empty base_url in update request for bedrock providers ([5bca3f8](https://github.com/xiayuanyin/aion_core/commit/5bca3f8f4064ff9023431306310ae59187eeca39))
* **realtime:** forward id and read nested data in subscribe-show-open ([#323](https://github.com/xiayuanyin/aion_core/issues/323)) ([7dc222f](https://github.com/xiayuanyin/aion_core/commit/7dc222fd444e3869e7b44101fa709e4704ad0a7e))
* recover deleted conversation workspaces ([#379](https://github.com/xiayuanyin/aion_core/issues/379)) ([759afb8](https://github.com/xiayuanyin/aion_core/commit/759afb88ed404a055abd686c427e5805161b812b))
* repair invalid UTF-8 agent metadata cache fields ([#526](https://github.com/xiayuanyin/aion_core/issues/526)) ([91969cd](https://github.com/xiayuanyin/aion_core/commit/91969cd765dbecf962ba3c986eb271dfc8208c0b))
* resolve ACP backends from metadata ([#559](https://github.com/xiayuanyin/aion_core/issues/559)) ([6c15bb7](https://github.com/xiayuanyin/aion_core/commit/6c15bb765f8c84baddd89830839c832424ef1789))
* revert console_layer to match main (remove .with_ansi(false)) ([e1dfe73](https://github.com/xiayuanyin/aion_core/commit/e1dfe73db029685bac99f2f293cfab586db1f0b1))
* **runtime:** anchor bun cache and agent spawn env under AppConfig.data_dir ([#250](https://github.com/xiayuanyin/aion_core/issues/250)) ([75a107d](https://github.com/xiayuanyin/aion_core/commit/75a107df41c708c67f6494f9499f41132c3798fb))
* **runtime:** create node symlink in bundled bun directory (ELECTRON-1EY) ([#310](https://github.com/xiayuanyin/aion_core/issues/310)) ([c0ad26b](https://github.com/xiayuanyin/aion_core/commit/c0ad26bb74008609a8dac815758aabc2284a8066))
* **runtime:** harden managed Node command resolution ([#565](https://github.com/xiayuanyin/aion_core/issues/565)) ([e69b83a](https://github.com/xiayuanyin/aion_core/commit/e69b83a836b369b4244a04b64f931bea1dd54743))
* **runtime:** include nvm node bins in startup path ([#261](https://github.com/xiayuanyin/aion_core/issues/261)) ([00c5762](https://github.com/xiayuanyin/aion_core/commit/00c57627592a567eb71fbc4edc564e2b579b86ee))
* **runtime:** make CLI detection work on Windows ([#276](https://github.com/xiayuanyin/aion_core/issues/276)) ([35bd121](https://github.com/xiayuanyin/aion_core/commit/35bd1217425a2e0d51f3e8f8e2f53ea37151c1eb))
* **runtime:** protect active ACP tasks from idle cleanup ([#561](https://github.com/xiayuanyin/aion_core/issues/561)) ([1fa7a54](https://github.com/xiayuanyin/aion_core/commit/1fa7a543e8fd4cec7e423443cbd6299de6a761ad))
* **runtime:** report bundled resource installation failures ([#420](https://github.com/xiayuanyin/aion_core/issues/420)) ([bc4b7d9](https://github.com/xiayuanyin/aion_core/commit/bc4b7d9315727b1e4fe00cb54c1230828dd37cf1))
* **runtime:** update Claude ACP package ([#599](https://github.com/xiayuanyin/aion_core/issues/599)) ([cf69332](https://github.com/xiayuanyin/aion_core/commit/cf693323913c31d3276a5e103b434c6ca51b519e))
* **runtime:** update managed Codex ACP package ([#598](https://github.com/xiayuanyin/aion_core/issues/598)) ([1bb2be7](https://github.com/xiayuanyin/aion_core/commit/1bb2be72a040d16f284d4a0b5b2de670aa2f864b))
* **runtime:** upgrade bundled bun from 1.1.38 to 1.3.13 ([#218](https://github.com/xiayuanyin/aion_core/issues/218)) ([bfc9ea6](https://github.com/xiayuanyin/aion_core/commit/bfc9ea6716be046e0b3639c4a1c1fe35a4d51a7b)), closes [#217](https://github.com/xiayuanyin/aion_core/issues/217)
* **runtime:** wait for extracted bun to be observable before returning ([#221](https://github.com/xiayuanyin/aion_core/issues/221)) ([7d3166e](https://github.com/xiayuanyin/aion_core/commit/7d3166ec6b2730b491000d936fca0fe72e375383)), closes [#220](https://github.com/xiayuanyin/aion_core/issues/220)
* scope bundled ACP output under tool directories ([#431](https://github.com/xiayuanyin/aion_core/issues/431)) ([d079395](https://github.com/xiayuanyin/aion_core/commit/d079395b0679d5b9450497a4d088bc478c5cf45f))
* **shell:** reveal file via FileManager1 D-Bus on Linux ([#466](https://github.com/xiayuanyin/aion_core/issues/466)) ([98c75ec](https://github.com/xiayuanyin/aion_core/commit/98c75ecc1bf20263f9bb682d8729d0924060f178))
* **shell:** support UNC paths in Windows terminal ([#411](https://github.com/xiayuanyin/aion_core/issues/411)) ([a041953](https://github.com/xiayuanyin/aion_core/commit/a04195329996b921cee811066994efb885b833e1))
* **skill:** raise import size limits ([#564](https://github.com/xiayuanyin/aion_core/issues/564)) ([50d9aff](https://github.com/xiayuanyin/aion_core/commit/50d9affe53ad64e994564a31215caab428eb7094))
* **skills:** correct AionUi Butler skill drift against current backend ([#557](https://github.com/xiayuanyin/aion_core/issues/557)) ([41c2c94](https://github.com/xiayuanyin/aion_core/commit/41c2c9426eefb2ce29de4a9f5b4e10c862a63994))
* **skills:** correct aionui-config butler skill drift (2026-07) ([#584](https://github.com/xiayuanyin/aion_core/issues/584)) ([e72e03f](https://github.com/xiayuanyin/aion_core/commit/e72e03ff6e1366f705352bcefec474887a85adfa))
* **skills:** repair butler endpoint drift + add cron scheduling ([#550](https://github.com/xiayuanyin/aion_core/issues/550)) ([88bcff3](https://github.com/xiayuanyin/aion_core/commit/88bcff3c08ebcd5e5dff8f16ba9c68fa313ef55f))
* **skills:** sync AionUi Butler skills + rule with current backend ([#520](https://github.com/xiayuanyin/aion_core/issues/520)) ([5603b9a](https://github.com/xiayuanyin/aion_core/commit/5603b9a77857b08d99d45c02eeeeb4d6d1e1e98a))
* split streamed message segments around tool boundaries ([#339](https://github.com/xiayuanyin/aion_core/issues/339)) ([476b1cc](https://github.com/xiayuanyin/aion_core/commit/476b1cc86f2adef8998477a666809dda50afca3e))
* **startup:** add backend readiness diagnostics ([#346](https://github.com/xiayuanyin/aion_core/issues/346)) ([ae8e01c](https://github.com/xiayuanyin/aion_core/commit/ae8e01c927118779bbad64da42a6b81aef27e9c9))
* **startup:** add startup phase diagnostics ([#388](https://github.com/xiayuanyin/aion_core/issues/388)) ([d24d027](https://github.com/xiayuanyin/aion_core/commit/d24d02726e03b852c8ee87caa872ed1605509143))
* stop defaulting aionrs max tokens ([22bc24b](https://github.com/xiayuanyin/aion_core/commit/22bc24b1f30ef4d475ccada7d36b3ee977054eba))
* **stt:** STT compatibility fixes for Groq Whisper and AionUI web frontend ([#400](https://github.com/xiayuanyin/aion_core/issues/400)) ([4c3fa09](https://github.com/xiayuanyin/aion_core/commit/4c3fa094087c8479d0c2975ec896ce46fb37abca))
* **stt:** treat blank base_url as unset and log malformed config ([#448](https://github.com/xiayuanyin/aion_core/issues/448)) ([f6b653b](https://github.com/xiayuanyin/aion_core/commit/f6b653bbdd5822dcd1b52790f0cf28db65115011))
* **system:** apply keep-awake client preference ([#642](https://github.com/xiayuanyin/aion_core/issues/642)) ([a6a290d](https://github.com/xiayuanyin/aion_core/commit/a6a290dd374a37eca73fc008c25bd6780a0e1f54))
* **team-mcp:** use fixed server name to stay within 64-char tool limit (ELECTRON-1JY) ([#336](https://github.com/xiayuanyin/aion_core/issues/336)) ([eaa3aa0](https://github.com/xiayuanyin/aion_core/commit/eaa3aa098816191d8531ef0f1de12292e5e47cc5))
* **team:** add name dedup check to rename_agent ([d9be99f](https://github.com/xiayuanyin/aion_core/commit/d9be99f39983761b04d109af4267102783ea0d01))
* **team:** add name dedup check to rename_agent ([7e335e4](https://github.com/xiayuanyin/aion_core/commit/7e335e445d48f3bf290c16fb170527970849ff26))
* **team:** add name dedup check to service-layer rename_agent ([58ef06a](https://github.com/xiayuanyin/aion_core/commit/58ef06a07bc9ebb85f309262a18a2cbedf405ea3))
* **team:** add POST /api/teams/{id}/session-mode endpoint and harden wake race ([130ee22](https://github.com/xiayuanyin/aion_core/commit/130ee22e74b149bf00133299e520774454fc843d))
* **team:** add session-mode endpoint and harden wake race ([ba12c6f](https://github.com/xiayuanyin/aion_core/commit/ba12c6f2d5baca8651724b56bf7aaaab064c2d1a))
* **team:** broadcast Stopped status on idle-cleanup team reclaim ([#640](https://github.com/xiayuanyin/aion_core/issues/640)) ([024a3a5](https://github.com/xiayuanyin/aion_core/commit/024a3a578936af0c59ed5aeed7bc1b4c20d990ea))
* **team:** close remaining gaps in event loop refactor ([79d43dd](https://github.com/xiayuanyin/aion_core/commit/79d43ddf81eecad892a0c12a4e74fab08884ee81))
* **team:** fix aion_list_models empty models + missing aionrs ([#228](https://github.com/xiayuanyin/aion_core/issues/228)) ([e8ad8b3](https://github.com/xiayuanyin/aion_core/commit/e8ad8b3916bb6614f3a33218ba79407e1ac3c343))
* **team:** force-stop agents on team delete, fix DashMap deadlock ([b3d8cd1](https://github.com/xiayuanyin/aion_core/commit/b3d8cd17407de2cc53d0dc09b22b790812822241))
* **team:** force-stop agents on team delete, fix DashMap deadlock ([7b9bf2b](https://github.com/xiayuanyin/aion_core/commit/7b9bf2b551813d9d49671014a32e74803e4e0412))
* **team:** inherit workspace for spawned agents ([#413](https://github.com/xiayuanyin/aion_core/issues/413)) ([82b31c5](https://github.com/xiayuanyin/aion_core/commit/82b31c5fbdb1e30a580865b4c441b1ac93ec5181))
* **team:** model routing + schema unification + lazy warm mode persistence ([#286](https://github.com/xiayuanyin/aion_core/issues/286)) ([199a392](https://github.com/xiayuanyin/aion_core/commit/199a392caca600ef215bb2ae71bfd82bda7bb744))
* **team:** move set_status(Working) to point-of-no-return in wake paths ([5415626](https://github.com/xiayuanyin/aion_core/commit/5415626dafef1eb962d411fa6e51c7ac4a655c75))
* **team:** pass workspace from CreateTeamRequest to agent conversations ([#273](https://github.com/xiayuanyin/aion_core/issues/273)) ([f4e3f32](https://github.com/xiayuanyin/aion_core/commit/f4e3f32e3a1a9f8fa34769205fa031b6037af00e))
* **team:** persist rename via service when MCP tool is used ([6af431c](https://github.com/xiayuanyin/aion_core/commit/6af431c87dfb8c9989b104377ab6cb2dbd05f89b))
* **team:** persist rename via service when MCP tool is used ([964c5ca](https://github.com/xiayuanyin/aion_core/commit/964c5cac85849408ee66c1ccfb94ca8584e03f9b))
* **team:** prevent guide MCP leak into team leaders ([#247](https://github.com/xiayuanyin/aion_core/issues/247)) ([71df5c6](https://github.com/xiayuanyin/aion_core/commit/71df5c64eab22d06ce0872d2226065bec1c026d7))
* **team:** remove 30s heartbeat polling from agent event loop ([752be98](https://github.com/xiayuanyin/aion_core/commit/752be981a487c1281fee48bf0b21d4d9c1574bbf))
* **team:** remove await_agent_finish deadlock, simplify event loop ([d08d3e6](https://github.com/xiayuanyin/aion_core/commit/d08d3e62ec5f7b02d5df9ecea45042c372eafb5f))
* **team:** remove redundant 30s heartbeat polling from event loop ([88672eb](https://github.com/xiayuanyin/aion_core/commit/88672ebb59aa9eb25e3396ed312bd1d807df4e07))
* **team:** resolve provider_id from providers table for aionrs spawn ([b02e590](https://github.com/xiayuanyin/aion_core/commit/b02e590d018d7236afb025660481a3375075d9cf))
* **team:** resolve provider_id from providers table for aionrs spawn ([86a9f41](https://github.com/xiayuanyin/aion_core/commit/86a9f41ab35705dd2352d3ff5c66b037807530a3))
* **team:** resolve provider_id from providers table for aionrs spawn ([c7efe54](https://github.com/xiayuanyin/aion_core/commit/c7efe54aa881d13d2e593850e0cd5ea74441a037))
* **team:** retry handoff turns after runtime release ([#480](https://github.com/xiayuanyin/aion_core/issues/480)) ([77d252f](https://github.com/xiayuanyin/aion_core/commit/77d252fdd7e43c740043bc3f7963a06a1461fec8))
* **test:** add missing extra_mcp_servers field in test helper ([de4aa7a](https://github.com/xiayuanyin/aion_core/commit/de4aa7a2781b379aed766b08a204eae75f3d7b9f))
* use provider and model protocol to determine llm request. ([37f76a8](https://github.com/xiayuanyin/aion_core/commit/37f76a8bf1ba8aafabb5dd6b6062da40173ef010))
* validate managed ACP packages via real entrypoints ([#429](https://github.com/xiayuanyin/aion_core/issues/429)) ([77221dd](https://github.com/xiayuanyin/aion_core/commit/77221ddddd883c56b954ca5cfea0f98038754efe))
* validate skill frontmatter as yaml ([#512](https://github.com/xiayuanyin/aion_core/issues/512)) ([6b46055](https://github.com/xiayuanyin/aion_core/commit/6b460552b63cdb6242703831c25443d9153fc25e))
* **windows:** handle runtime process lifecycle ([399f920](https://github.com/xiayuanyin/aion_core/commit/399f920c31ab4d738ffa32b5ebcff9416ba44e6f))


### Performance Improvements

* **team:** lazy warm — only start agent processes on first message ([#282](https://github.com/xiayuanyin/aion_core/issues/282)) ([6281f31](https://github.com/xiayuanyin/aion_core/commit/6281f31ac6a2656c1af51891589770f4583e00c2))


### Code Refactoring

* **acp:** replace first-message flag with PromptPipeline + hooks ([#262](https://github.com/xiayuanyin/aion_core/issues/262)) ([d1f3c95](https://github.com/xiayuanyin/aion_core/commit/d1f3c95eebea4053c45b56dcd973fe4e44f0fe6c))
* **ai-agent,conversation:** move session ops, tighten visibility, fix idle scanner + backfill ACP metadata ([#254](https://github.com/xiayuanyin/aion_core/issues/254)) ([299c5d3](https://github.com/xiayuanyin/aion_core/commit/299c5d30e7674d91136139886c9b02a99b932515))
* **ai-agent:** ACP aggregate state cleanup + observed-state persistence ([#199](https://github.com/xiayuanyin/aion_core/issues/199)) ([70790f8](https://github.com/xiayuanyin/aion_core/commit/70790f86370fe28d44e958e1b9bb6308c03878bf))
* **ai-agent:** ACP state management enhancements ([#201](https://github.com/xiayuanyin/aion_core/issues/201)) ([17eaf6d](https://github.com/xiayuanyin/aion_core/commit/17eaf6d66f41af0ffaf3a483b0068b63d73409b1))
* **ai-agent:** split AcpAgentManager construction into new+init phases ([#202](https://github.com/xiayuanyin/aion_core/issues/202)) ([dcb638a](https://github.com/xiayuanyin/aion_core/commit/dcb638a9e47baad289b8f3cf794e74801203ecc9))
* **aionrs:** use Config::resolve() for consistent config loading ([e5dddd7](https://github.com/xiayuanyin/aion_core/commit/e5dddd73ad4962a29861504b598e0d9902dcd87f))
* **aionrs:** use Config::resolve() for consistent config loading ([31ecc67](https://github.com/xiayuanyin/aion_core/commit/31ecc678dd5bb4956cc94509b5fd7020f82686ef))
* **app:** extract CLI definitions to cli.rs ([#280](https://github.com/xiayuanyin/aion_core/issues/280)) ([5685d52](https://github.com/xiayuanyin/aion_core/commit/5685d5237b8f51c70e80895b1c654325c958196e))
* **app:** introduce commands/ module with layered bootstrap for subcommands ([#283](https://github.com/xiayuanyin/aion_core/issues/283)) ([1216597](https://github.com/xiayuanyin/aion_core/commit/12165971cfae61d85376c102ef9f9afc5a7c5bbf))
* **app:** organize CLI command boundaries ([#423](https://github.com/xiayuanyin/aion_core/issues/423)) ([cc84d52](https://github.com/xiayuanyin/aion_core/commit/cc84d523f1014978b0fb9c880842d4fd29330925))
* **app:** replace argv sniffing with clap Subcommand for mcp-* helpers ([#277](https://github.com/xiayuanyin/aion_core/issues/277)) ([c3d137c](https://github.com/xiayuanyin/aion_core/commit/c3d137c9e5fdcb12e29d5ca7abd6a0585bbc6c8d))
* **app:** split monolithic lib.rs/main.rs into per-module files ([#284](https://github.com/xiayuanyin/aion_core/issues/284)) ([f3462cb](https://github.com/xiayuanyin/aion_core/commit/f3462cbb1d6d830a3a368a76b2d9ea6424f21b64))
* **assistant:** finalize unified governance storage ([#449](https://github.com/xiayuanyin/aion_core/issues/449)) ([aba2d2a](https://github.com/xiayuanyin/aion_core/commit/aba2d2acc0a855152ae372c04b4249e956fc4cbf))
* centralize agent runtime session context building ([#419](https://github.com/xiayuanyin/aion_core/issues/419)) ([b21f833](https://github.com/xiayuanyin/aion_core/commit/b21f8334e2955c73be4acb2beb76c79133e2120a))
* centralize runtime turn lifecycle ([#421](https://github.com/xiayuanyin/aion_core/issues/421)) ([282c68c](https://github.com/xiayuanyin/aion_core/commit/282c68cb43a6c06862ee61c7441a9dd52a3008b7))
* **conversation:** simplify clone and improve test coverage ([#246](https://github.com/xiayuanyin/aion_core/issues/246)) ([91c322b](https://github.com/xiayuanyin/aion_core/commit/91c322bb5427c4cca739595b988561ceb40efa54))
* **db:** absorb 014_behavior_policy_supports_team into 001 seed data ([#234](https://github.com/xiayuanyin/aion_core/issues/234)) ([c8e584b](https://github.com/xiayuanyin/aion_core/commit/c8e584b55e5921cfe5524495508aff3aae37d3cc))
* **db:** consolidate migrations + fix aionrs session resume ([#233](https://github.com/xiayuanyin/aion_core/issues/233)) ([1ebb78a](https://github.com/xiayuanyin/aion_core/commit/1ebb78afa7177e9a8919d329cfe205b93c096804))
* **error:** finish ApiError phase3 ([#398](https://github.com/xiayuanyin/aion_core/issues/398)) ([37523ab](https://github.com/xiayuanyin/aion_core/commit/37523ab628abdfaa29eaf5b0b713cb2251062146))
* **error:** migrate phase2 service errors ([#395](https://github.com/xiayuanyin/aion_core/issues/395)) ([c6c42ee](https://github.com/xiayuanyin/aion_core/commit/c6c42eea051083c94eb822163149de6fef2387a3))
* four-layer architecture (connect / conv / biz) ([#349](https://github.com/xiayuanyin/aion_core/issues/349)) ([2a11285](https://github.com/xiayuanyin/aion_core/commit/2a11285e316ffc7f0076d385dad8e09a4af2de4b))
* rename binary from aioncli to aioncore ([#293](https://github.com/xiayuanyin/aion_core/issues/293)) ([ae78cd1](https://github.com/xiayuanyin/aion_core/commit/ae78cd19f599fb3c8845ba5d3e208a75bf310368))
* rename binary from aionui-backend to aioncli ([#289](https://github.com/xiayuanyin/aion_core/issues/289)) ([30eeca3](https://github.com/xiayuanyin/aion_core/commit/30eeca37661441ba9474aa7dc51ca911abda0bfb))
* roll out aionui_runtime::Builder to office/extension/shell ([#196](https://github.com/xiayuanyin/aion_core/issues/196)) ([18f10c3](https://github.com/xiayuanyin/aion_core/commit/18f10c325b87567e3c8dbf13cde39c4787a4a501))
* **runtime:** remove legacy Bun runtime support ([#623](https://github.com/xiayuanyin/aion_core/issues/623)) ([01b5eed](https://github.com/xiayuanyin/aion_core/commit/01b5eed0db886e05b652c4633c9acd337087e1ab))
* **team:** pull-based event loop for agent lifecycle ([de891f6](https://github.com/xiayuanyin/aion_core/commit/de891f6038dd4037b2575b09f24d22aac899b087))
* **team:** replace push-based finish_subscribers with pull-based event loop ([3a05785](https://github.com/xiayuanyin/aion_core/commit/3a05785771632d3510d1830f49c47357d065122e))
* **team:** use let-chains syntax in wake_agent_in_session ([e6c4d22](https://github.com/xiayuanyin/aion_core/commit/e6c4d22833de82011958fdb816d8bfa839994342))


### Documentation

* **assistants:** add word-form-creator to preset-id-whitelist ([#252](https://github.com/xiayuanyin/aion_core/issues/252)) ([343b15b](https://github.com/xiayuanyin/aion_core/commit/343b15bc5ab362c566ae0d8e2ed61921d58b9497))
* catch up with aionui-backend → AionCore rename ([#301](https://github.com/xiayuanyin/aion_core/issues/301)) ([40a7e83](https://github.com/xiayuanyin/aion_core/commit/40a7e83618bb62b145378e333e26b66dc0061c89))
* clarify production logging guidance ([#460](https://github.com/xiayuanyin/aion_core/issues/460)) ([118ed03](https://github.com/xiayuanyin/aion_core/commit/118ed03b5393ec87edf8801ed7395d917c87855a))
* clean up AGENTS.md and sync ARCHITECTURE.md ([a6d1efa](https://github.com/xiayuanyin/aion_core/commit/a6d1efaf3d8167f1cb7987249938768410b9f1be))
* **skills:** add cross-platform notes so Windows users translate shell examples ([#489](https://github.com/xiayuanyin/aion_core/issues/489)) ([e03b030](https://github.com/xiayuanyin/aion_core/commit/e03b0309c9fcd4914175d22787efa90e9599c8ec))
