...
/// Request body for an out-of-band channel message.
///
/// The message object uses the channel unified-message shape. WeCom accepts
/// text (encoded as Markdown) and button/template-card messages for pushes.
#[derive(Debug, Deserialize)]
pub struct ChannelActiveMessageRequest {
    pub chat_id: String,
    pub message: serde_json::Value,
}

/// Result of an out-of-band channel message.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
pub struct ChannelActiveMessageResponse {
    /// Correlation id generated by AionCore. WeCom does not return a message
    /// id for `aibot_send_msg` acknowledgements.
